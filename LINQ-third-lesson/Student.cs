namespace LINQ
{
    public class Student1
    {
        ...
        public string Talim_shakli { get; set; }
        ...
        public static List<Student1> GetAllStudents()
        {
            List<Student1> students = new List<Student1>()
            {
                new Student1 { Id = 1, FirstName = "Rustambek", LastName = "Jurayev", Age = 23, Credite = 8,
                    ...
                    UniversityFaculty = "Qishloq xo'jaligi", Course = 1 , Talim_shakli="Kunduzgi"},
                ...
                new Student1 { Id = 2, FirstName = "Nurmuhammad", LastName = "SHarobiddinov", Age = 20, Credite = 8,
                    ...
                    UniversityFaculty = "Komputer Science", Course = 3, Talim_shakli="Kechgi" },
                ...
                new Student1 { Id = 3, FirstName = "Hushnud", LastName = "Kamolov", Age = 33, Credite = 21,
                    ...
                    UniversityFaculty = "Fizika", Course = 2, Talim_shakli="sirtqi" },
                ...
                new Student1 { Id = 4, FirstName = "Mirqosim", LastName = "Uzoqov", Age = 28, Credite = 40,
                    ...
                    UniversityFaculty = "Logistika", Course = 4,Talim_shakli="Kunduzgi" },
                ...
                new Student1 { Id = 4, FirstName = "Bahriddin", LastName = "Axunov", Age = 28, Credite = 40,
                    Contract = 7_000_100, UniversityBranch = "Buhoro", UniversityName = "INHA",
                    UniversityFaculty = "Logistika", Course = 4, Talim_shakli="sirtqi"},
                ...
                new Student1 { Id = 5, FirstName = "Jonpo'lat", LastName = "Jurayev", Age = 23, Credite = 10,
                    ...
                    UniversityFaculty = "Tafseer", Course = 1 ,Talim_shakli="Kechgi"},
                ...
                new Student1 { Id = 6, FirstName = "Sevinch", LastName = "Xayriddinova", Age = 31, Credite = 15,
                    ...
                    UniversityFaculty = "Komputer Injiniringi", Course = 3 , Talim_shakli="Kunduzgi"},
                ...
                new Student1 { Id = 7, FirstName = "Farxodbek", LastName = "Madrahimov", Age = 27, Credite = 32,
                    ...
                    UniversityFaculty = "Matematika", Course = 4 ,Talim_shakli="sirtqi"},
                ...
                new Student1 { Id = 8, FirstName = "Farxodbek", LastName = "Rustamov", Age = 19, Credite = 57,
                    ...
                    UniversityFaculty = "Kareys tili", Course = 2 ,Talim_shakli="Kechgi"},
            };
        ...
        public static List<Teacher> GetAllTeachers()
        {
            ...
            {
                new Teacher { Id = 1, FirstName = "Asror", Age = 27, Spetiality = "Dasturlash", TechCourse = 1, Talim_shakli="Kunduzgi" },
                new Teacher { Id = 2, FirstName = "Muhammad Abdulloh", Age = 23, Spetiality = "DotNet", TechCourse = 2 , Talim_shakli="Kunduzgi"},
                new Teacher { Id = 3, FirstName = "Rustambek", Age = 15, Spetiality = "Backend", TechCourse = 4 ,Talim_shakli="Kechgi"},
                new Teacher { Id = 4, FirstName = "Nodir", Age = 29, Spetiality = "Frontend", TechCourse = 3, Talim_shakli="Kechgi"}
            };
